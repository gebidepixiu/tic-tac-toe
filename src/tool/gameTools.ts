 ...
 * @param gameMode 游戏类型
 * */
export const determineLattice = (chessboard: { placingPieces:InLattice, latticeList:InLattice[] }, gameMode:number) => {
 ...
 * */
const opDetermineLattice = (latticeList:InLattice[], gameMode:number, placingPieces:InLattice) => {
